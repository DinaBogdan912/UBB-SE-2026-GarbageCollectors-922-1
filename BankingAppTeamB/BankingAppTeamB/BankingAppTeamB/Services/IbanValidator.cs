...
namespace BankingAppTeamB.Services
{
    internal static class IbanValidator
    {
        ...
        /// <summary>Returns <see langword="true"/> when <paramref name="iban"/> is non-empty, between 15–34 characters, starts with two letters, and has two digits in positions 3–4. Does not verify the checksum.</summary>
